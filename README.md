...
1. **finding_numbers** folder contains a script (finding_numbers.py) and data to run the script on (finding_numbers.txt, [source](http://py4e-data.dr-chuck.net/)). The script performs following tasks based on the provided command line arguments:
